...
<div class="max-w-site mx-auto px-5 pt-5 pb-12 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8">
  <main class="min-w-0">
    ...
    <div style="display:flex;flex-wrap:wrap;align-items:center;gap:0.5rem;color:#6B7280;font-size:12px;margin-bottom:1.2rem;">
      ...
      <span style="margin-left:auto;display:flex;gap:6px;">
        <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode( get_the_title() ); ?>&url=<?php echo urlencode( get_permalink() ); ?>"
           target="_blank" rel="noopener" title="X でシェア"
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode( get_permalink() ); ?>"
           target="_blank" rel="noopener" title="Facebook でシェア"
        ...
        <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode( get_permalink() ); ?>"
           target="_blank" rel="noopener" title="LinkedIn でシェア"
           style="display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:6px;background:#0A66C2;color:#fff;text-decoration:none;">
        ...
        <a href="https://line.me/R/msg/text/?<?php echo urlencode( get_the_title() . ' ' . get_permalink() ); ?>"
           target="_blank" rel="noopener" title="LINE でシェア"
        ...
        <a href="mailto:?subject=<?php echo rawurlencode( get_the_title() ); ?>&body=<?php echo rawurlencode( get_the_title() . "\n\n" . get_permalink() ); ?>"
           title="メールでシェア"
           style="display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:6px;background:#555;color:#fff;text-decoration:none;">
    ...
    <?php
    // 記事本文にCTAボックスが含まれていない場合のみテンプレートCTAを表示
    $has_content_cta = strpos( get_the_content(), 'cta-box' ) !== false
                    || strpos( get_the_content(), 'hj_cta' ) !== false
                    || strpos( get_the_content(), 'hj-auto-cta' ) !== false;
    if ( ! $has_content_cta ) :
    ?>
    <!-- 記事末尾CTA: 補助金一覧 -->
